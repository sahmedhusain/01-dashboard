import{r as S,j as e,m}from"./animation-vendor-BWQ_wUI_.js";import{C as p}from"./Card-boLi8-L0.js";import{L as ne}from"./index-DIwVma_V.js";import{i as u,d as ie,e as l}from"./apollo-vendor-8AJvV5pX.js";import{W as A,e as P,f as ce,s as M,o as Q,A as le,r as de,X as y,u as V,g as xe,R as me,D as pe,B as ue}from"./ui-vendor-BusGUpMC.js";import"./react-vendor-DJG_os-6.js";const ge=l`
...
`,Te=({user:C})=>{const[g,D]=S.useState({}),[n,z]=S.useState("users"),[r,K]=S.useState("json"),[w,W]=S.useState(!0),[I]=u(ge,{errorPolicy:"all"}),[G]=u(he,{errorPolicy:"all"}),[k]=u(be,{errorPolicy:"all"}),[U]=u(je,{errorPolicy:"all"}),[F]=u(ye,{errorPolicy:"all"}),[q]=u(we,{errorPolicy:"all"}),[X]=u(fe,{errorPolicy:"all"}),[B]=u(Ne,{errorPolicy:"all"}),{data:Y,loading:Z}=ie(l`
