...
`,Ce=({user:C})=>{const[g,D]=S.useState({}),[n,z]=S.useState("users"),[r,K]=S.useState("json"),[w,W]=S.useState(!0),[I]=u(ge,{errorPolicy:"all"}),[G]=u(he,{errorPolicy:"all"}),[k]=u(be,{errorPolicy:"all"}),[U]=u(je,{errorPolicy:"all"}),[F]=u(ye,{errorPolicy:"all"}),[q]=u(we,{errorPolicy:"all"}),[X]=u(fe,{errorPolicy:"all"}),[B]=u(Ne,{errorPolicy:"all"}),{data:Y,loading:Z}=ue(l`
