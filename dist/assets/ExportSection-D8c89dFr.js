import{r as S,j as e,m}from"./animation-vendor-BWQ_wUI_.js";import{L as ne,C as p}from"./index-DVb5-10c.js";import{j as g,d as ie,e as l}from"./apollo-vendor-NpLSqJf6.js";import{w as A,e as P,f as ce,l as M,p as Q,A as le,j as de,x as y,i as V,g as xe,R as me,D as pe,B as ge}from"./ui-vendor-DEyZM_km.js";import"./react-vendor-DJG_os-6.js";const ue=l`
...
`,Ce=({user:C})=>{const[u,D]=S.useState({}),[n,z]=S.useState("users"),[r,K]=S.useState("json"),[w,W]=S.useState(!0),[I]=g(ue,{errorPolicy:"all"}),[G]=g(he,{errorPolicy:"all"}),[k]=g(be,{errorPolicy:"all"}),[U]=g(je,{errorPolicy:"all"}),[F]=g(ye,{errorPolicy:"all"}),[q]=g(we,{errorPolicy:"all"}),[X]=g(fe,{errorPolicy:"all"}),[B]=g(Ne,{errorPolicy:"all"}),{data:Y,loading:Z}=ie(l`
