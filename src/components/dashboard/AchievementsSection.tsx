...
const AchievementsSection = () => {
  ...
  const achievementsData = useMemo(() => {
    ...
    const achievements = {
      xp: [
        { id: 'first_xp', name: 'First Steps', description: 'Earn your first XP', threshold: 1, icon: Star, unlocked: totalXPNumber >= 1, rarity: 'common' },
        { id: 'xp_10k', name: 'Rising Star', description: 'Accumulate 10K XP', threshold: 10000, icon: TrendingUp, unlocked: totalXPNumber >= 10000, rarity: 'common' },
        { id: 'xp_25k', name: 'Dedicated Learner', description: 'Reach 25K XP milestone', threshold: 25000, icon: BookOpen, unlocked: totalXPNumber >= 25000, rarity: 'uncommon' },
        { id: 'xp_50k', name: 'Knowledge Seeker', description: 'Achieve 50K XP', threshold: 50000, icon: Target, unlocked: totalXPNumber >= 50000, rarity: 'uncommon' },
        { id: 'xp_100k', name: 'XP Master', description: 'Reach the 100K XP milestone', threshold: 100000, icon: Crown, unlocked: totalXPNumber >= 100000, rarity: 'rare' },
        { id: 'xp_250k', name: 'Legend', description: 'Accumulate 250K XP', threshold: 250000, icon: Trophy, unlocked: totalXPNumber >= 250000, rarity: 'epic' }
      ],
      projects: [
