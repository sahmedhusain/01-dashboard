...
const ComparativeAnalyticsSection = () => {
  ...
  const comparativeData = useMemo(() => {
    ...
    const cohortRankings = [
      ...
      { rank: 4, name: 'You', xp: totalXP, level: level, badge: 'user', isUser: true },
    ...
    const benchmarks = [
      {
        ...
        userScore: totalXP,
        benchmarks: [
          { level: 'Beginner', threshold: 25000, achieved: totalXP >= 25000 },
          { level: 'Intermediate', threshold: 75000, achieved: totalXP >= 75000 },
          { level: 'Advanced', threshold: 150000, achieved: totalXP >= 150000 },
          { level: 'Expert', threshold: 300000, achieved: totalXP >= 300000 }
        ]
      },
      {
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold text-primary-400">
                    {(comparativeData.peerComparison.xp.userValue / 1000).toFixed(1)}K
                  </span>
                </div>
                <div className="flex items-center justify-between">
