...
const ProgressTrackingSection = () => {
  ...
  const progressData = useMemo(() => {
    ...
    const milestones = [
      ...
      { name: '25K XP', threshold: 25000, completed: totalXP >= 25000 },
      { name: '50K XP', threshold: 50000, completed: totalXP >= 50000 },
      { name: '100K XP', threshold: 100000, completed: totalXP >= 100000 },
            ...
            <Card.Content>
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold text-primary-400">
                    {(progressData.overallProgress.totalXP / 1000).toFixed(1)}K
                  </span>
                </div>
                <div className="flex items-center justify-between">
