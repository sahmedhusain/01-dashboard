...
export const DeploymentUtils = {
  ...
  validateProductionReadiness: () => {
    ...
    if (typeof window !== 'undefined' && 'performance' in window) {
      const navigation = performance.getEntriesByType('navigation')[0] as PerformanceNavigationTimingWithSize;
      if (navigation && navigation.transferSize && navigation.transferSize > PRODUCTION_CONFIG.performance.bundleSizeWarning) {
