...
import { graphqlService } from '../graphql/dataService';
import { processUserAnalytics } from '../utils/dataProcessing';
...
export const useGraphQLData = (fetchFunction: () => Promise<any>, dependencies: any[] = [], options: any = {}) => {
...
export const useUserInfo = (userLogin: string) => {
...
// Hook for total XP
export const useTotalXP = (userLogin: string) => {
  return useGraphQLData(() => graphqlService.getTotalXP(userLogin));
};
...
export const useUserSkills = (userLogin: string) => {
  return useGraphQLData(() => graphqlService.getUserSkills(userLogin));
};
...
export const useAuditRatio = (userLogin: string) => {
  return useGraphQLData(() => graphqlService.getAuditRatio(userLogin));
};
