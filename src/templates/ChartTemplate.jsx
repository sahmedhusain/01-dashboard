...
import { useUserSkills, useXPByProject } from '../hooks/useGraphQLData.js';
import { processSkillsData, processXPByProject, formatNumber } from '../utils/dataProcessing.js';
...
const BarChart = ({ data, config, title }) => {
  const chartData = useMemo(() => {
    ...
    const dimensions = calculateChartDimensions(data, config);
