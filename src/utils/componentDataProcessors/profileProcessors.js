 ...
 */
export const processUserProfileInfo = (user) => {
  if (!user) {
    return {
 ...
 */
export const processUserLevelInfo = (totalXP, level) => {
 ...
 */
export const processUserProjectStats = (passedProjects, failedProjects, passRate) => {
 ...
 */
export const processUserAuditStats = (auditRatio, totalUp, totalDown) => {
 ...
 */
export const processUserSkills = (skills, totalXP, maxSkills = 5) => {
 ...
 */
export const processProfileSectionData = (data) => {
  if (!data) {
    return {
 ...
 */
export const processProfileBadges = (profileData) => {
  const badges = [];
 ...
 */
export const processQuickStats = (profileData) => {
 ...
 */
export const getProfileCompletion = (profileData) => {
